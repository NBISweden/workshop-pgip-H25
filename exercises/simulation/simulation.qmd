...
We will look into more comparisons to real Monkeyflower data in an
upcoming exercise, but hopefully this has given you an idea of what
simulations can be used for in an experiment!
