---
title: Variant calling exercises
description: List of variant calling exercises
format:
  nbis-course-html:
...
#| echo: true
#| eval: false
pgip exercises setup variant-calling -v
```

#### {{< fa laptop >}} Local

Create an exercise directory called `exercises` and `cd` to it:
...
1. [Data preparation, quality control and
