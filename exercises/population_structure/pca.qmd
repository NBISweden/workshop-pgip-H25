...
- not model-based - gives no information about the underlying
  demographic process [@novembre_InterpretingPrincipalComponent_2008]
- sensitive to unequal sampling
  [@mcvean_GenealogicalInterpretationPrincipal_2009]
