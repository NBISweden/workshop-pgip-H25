...
- multiple-population histories in which migration/hybridization takes
  place form *reticulate* networks as opposed to *bifurcating* trees
- D-statistics (ABBA-BABA) tests infer signs of introgression
- f-statistics were developed to detect admixture from data
  - $f_2$ measures the total branch length between populations
  - $f_3$ tests whether P1 is an admixture of P2 and P3
  - $f_4$ tests for independence between P1, P2 and P3, P4

The aforementioned statistics and tests have previously been
implemented in {{< var tools.admixtools.fmt >}}.

in the
computationally effective package {{< var tools.admixtools2.fmt >}}.
The package is very comprehensive, and we will in this exercise only
scratch the surface of its capabilities. For a more thorough overview,
see [the admixtools
...
#| fig-height: 8
#| fig-cap:
#|   Genome-wide estimates of Patterson’s f4-statistic (this is similar
