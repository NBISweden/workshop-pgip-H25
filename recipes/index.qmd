...
For full listing, see [slides/index.html](/recipes/slides/index.qmd).

## SLiM recipes

Collection of SLiM recipes [@hallerben_MesserLabSLiM_2016] used to
generate figures and examples. See
[slim/index.html](/recipes/slim/index.qmd) for full listing.
