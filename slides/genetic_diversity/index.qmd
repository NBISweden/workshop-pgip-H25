...
#| eval: true
#| results: hide
vcftools --gzvcf data/allsites.vcf.gz --window-pi 1000 --out results/out
...
#| eval: true
#| results: hide
vcftools --gzvcf data/allsites.vcf.gz --weir-fst-pop PUN-Y.txt \
...
#| echo: true
#| eval: true
csvtk filter2 --tabs data/annotation.gff --filter ' $3 == "CDS" ' |\
 ...
 csvtk cut --tabs --fields 1,10,11 | bedtools sort | bedtools merge \
    > data/CDS.bed 2>/dev/null
head -n 3 data/CDS.bed
```
...
#| eval: true
#| results: hide
pixy --vcf data/allsites.vcf.gz --stats pi \
 --populations populations.txt --output_prefix cds \
 --output_folder results --bed_file data/CDS.bed
pixy --vcf data/allsites.vcf.gz --stats pi \
